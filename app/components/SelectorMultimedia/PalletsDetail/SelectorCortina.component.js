            ...
            <View>
                ...
                <View style={{ flexDirection: 'row', justifyContent: "flex-start", alignItems: "center", marginTop: 5 ,width:'90%' }}>
                    ...
                    {this.state.estacargado == true ? (
                        ...
                        <Text style={{ color:'#ef882d', fontWeight:'bold', marginTop:5}}>Controlled atmosphere curtaine</Text> 
                        </View>                        
                        <View style={{flex:.5}}>
                        ...
                        </Text><Icon2 style={{paddingTop:10,marginLeft:'10%', paddingRight:20}} name="camera" size={30} color="#ef882d" />
                        </View>
