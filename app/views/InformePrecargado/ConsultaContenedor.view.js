        ...
        return (
            <View style={{ flex: 1 , backgroundColor: '#6c649c'}}>
                <View style={{ flex: 0.2 ,alignItems:'center', flexDirection: 'row'}} >
                    ...
                    <Text style={{flex:1,marginLeft:80, color:'white',marginTop:0, fontSize:18}}>Consulta Contenedor </Text><Icon style={{marginRight:20}} name="exit-outline" size={30} color="#FFFF" />
