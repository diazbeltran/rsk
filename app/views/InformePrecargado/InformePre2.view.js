...
import { View, Text, TextInput , StyleSheet,
  Image,Button , FlatList, TouchableOpacity, 
  TouchableWithoutFeedback,ScrollView, RefreshControl,Platform, BackHandler , AppState} from 'react-native';
...
export default class InformePrecargado2 extends Component {
    ...
    constructor(props) {
        ...
        super(props);
        //this.carga_datos= this.carga_datos.bind(this);
        this.carga_datos = this.carga_datos.bind(this);
        this.state = {
            status: false,
            Imagen:false, 
...
//    async componentDidMount(){
        ...
        AppState.addEventListener('change', this.carga_datos);
    ...
    //       console.log("datox 1 :", prevProps);
    //       console.log("datox 2 :", prevState);
    ...
    getSnapshotBeforeUpdate = async(nextProps, nextState) =>{
      console.log('Ejecutando lista getSnapshotBeforeUpdate 1: ', nextProps )
      console.log('Ejecutando lista getSnapshotBeforeUpdate 2: ', nextState )
     ...
     console.log('Ejecutando lista shouldComponentUpdate 2: ', nextState )
        ...
        if(nextProps.route.params.dato_act==3){
          //this.recarga();
          ...
          <View style={{borderTopLeftRadius: 20, borderTopRightRadius: 20,  flex: 1, backgroundColor: 'white', flexDirection: 'column'}} >
                  ...
                  <View style={{ flexDirection: "row", alignItems: "center" }}>
                      <FlatList
                        ...
                        refreshing={true}
                        extraData={this.state.actualiza}
